...
group_2.default.belongsToMany(user_2.default, { through: admin_2.default, as: 'userAdmins' });
user_2.default.belongsToMany(group_2.default, { through: admin_2.default, as: 'groupAdmins' });
database_1.default
    .sync()
    .then((res) => {
    app.listen(3000);
